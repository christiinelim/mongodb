...
async function main() {
    ...
    */
    ...
    // Add a new note tot he food sighting with the id specific in the URL
    app.post('/food-sighting/:foodsightingid', async (req, res) => {
        const foodSighingId = req.params.foodsightingid;
        const newNote = {
            _id: new ObjectId(),
            email: req.body.email,
        ...
        const result = await db.collection('sightings').updateOne({
            '_id': new ObjectId(foodSighingId)
        }, {
            '$push': {
                'notes': newNote
            }
    ...
    // Delete a note from existing food sighting document
    app.delete('/food-sighting/:foodsightingid/note/:noteid', async (req, res) => {
    ...
    app.put('/food-sighting/:foodsightingid/note/:noteid', async (req, res) => {
        const foodSightingId = req.params.foodsightingid;
        const noteId = req.params.noteid;
